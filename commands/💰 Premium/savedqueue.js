  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    switch (Type.toLowerCase()) {
      case `addcurrenttrack`: {
        ...
        return message.reply({
          embeds: [new MessageEmbed()
            .setTitle(`<a:yesss:961036336813461534> Added ${track.title} onto the Queue \`${Name}\``.substr(0, 256))
    ...
    case `removesong`: {
      ...
      return message.reply({
        embeds: [new MessageEmbed()
          .setTitle(`<a:yesss:961036336813461534> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
    ...
    case `mix`: {
      ...
      return message.reply({
        embeds: [new MessageEmbed()
          .setTitle(`<a:yesss:961036336813461534> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substr(0, 256))
    ...
    case `removeduplicates`: {
      ...
      return message.reply({
        embeds: [new MessageEmbed()
          .setTitle(`<a:yesss:961036336813461534> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
