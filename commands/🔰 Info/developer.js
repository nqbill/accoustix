...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let button_public_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.invite).setURL("https://discord.com/api/oauth2/authorize?client_id=961022525385609216&permissions=8&scope=bot%20applications.commands")
    ...
    let button_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.botlist).setURL(`https://homely.dev`)
    ...
    message.reply({
      embeds: [new MessageEmbed()
        ...
        .setTimestamp()
        .setThumbnail("https://raw.githubusercontent.com/nqbill/Accoustix/main/src/img/accoustix_round.png?size=1024")
        .setTitle(client.la[ls].cmds.info.developer.title)
        .setURL("https://discord.gg/homely")
