...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite Public Bot').setURL("https://discord.com/api/oauth2/authorize?client_id=961022525385609216&permissions=8&scope=bot%20applications.commands")
    ...
    message.reply({
      embeds: [new MessageEmbed()
        ...
        .setFooter('Squidy | powered by homely.dev', 'https://raw.githubusercontent.com/nqbill/Accoustix/main/src/img/accoustix_round.png')
