...
module.exports = {
  ...
  options: [ 
    ...
    try {    
      if(user) {
        if(!user.bot) return interaction.reply({ephemeral: true, content: "<a:nooo:961036403075072071> You can't Invite a Normal user! **IT MUST BE A BOT**"})
        let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=958463456011509862&permissions=8&scope=bot%20applications.commands")
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/homely")
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by homely.dev`, "https://raw.githubusercontent.com/nqbill/Accoustix/main/src/img/accoustix_round.png"))],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by homely.dev`, "https://raw.githubusercontent.com/nqbill/Accoustix/main/src/img/accoustix_round.png")],
          components: allbuttons
        });
      }
    } catch (e) {
